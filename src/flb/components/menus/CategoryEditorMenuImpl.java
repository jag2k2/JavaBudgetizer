...
public class CategoryEditorMenuImpl implements MenuDisplayer {
    ...
    protected void buildMenu(int activeRow, int activeColumn) {
        popupMenu.removeAll();
        if(activeColumn == 0) {
            JMenuItem deleteCategory = new JMenuItem("Delete");
            ...
            JMenuItem clearCategory = new JMenuItem("Clear");
            clearCategory.addActionListener(new UserClearsGoalListener(categoryClearer, nameFilter));
